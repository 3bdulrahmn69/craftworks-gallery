      ...
      <div className="relative z-10 px-6 py-20 w-full">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-300 leading-relaxed">
            A cross-platform Flutter application providing seamless experiences
            for clients and craftsmen. Post jobs, hire professionals, and manage
            projects directly from your smartphone with real-time updates.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a
              ...
              aria-label="View Mobile App Demo"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              { label: 'Languages', value: 'Arabic & English', icon: FiMapPin },
              { label: 'Real-time', value: 'Real-time Chat', icon: FiBell },
            ].map((stat, index) => {
