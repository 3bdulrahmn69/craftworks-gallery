      ...
      <div className="relative z-10 px-6 py-20 w-full">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-300 leading-relaxed">
            A modern Next.js application showcasing advanced React development,
            real-time communication, and responsive design. Built to provide an
            exceptional user experience for connecting clients with craftsmen.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              { label: 'Page Load Speed', value: '<2s', icon: FiZap },
              { label: 'Component Library', value: '80+', icon: FiUsers },
              { label: 'Real-time Features', value: 'Live', icon: FiMonitor },
            ].map((stat, index) => {
